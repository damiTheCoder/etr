...
export default function APAging() {
  ...
  useEffect(() => {
    async function load() {
      try {
        const res = await api.getReport('ap-aging')
        setAging(res)
      } catch (e) {
        console.error(e)
      }
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 no-print">
        ...
        <div className="flex gap-2">
          ...
          <Button
            size="sm"
            onClick={() => exportToPDF('Accounts Payable Aging')}
            className="bg-blue-600 hover:bg-blue-700 text-white border border-black font-semibold"
          >
            Export PDF
          </Button>
      ...
      <Card className="border-0 bg-transparent shadow-none p-0">
        <CardHeader className="border-0 px-0 py-4 bg-transparent">
          <CardTitle className="text-black font-bold">AP Aging Breakdown</CardTitle>
          ...
          <div className="overflow-x-auto bg-transparent">
            <Table className="w-full bg-transparent border-0">
              ...
              <TableBody className="bg-transparent">
                <TableRow className="border-0 bg-transparent">
                  <TableCell className="font-semibold text-black">Creditors (Accounts Payable)</TableCell>
                ...
                <TableRow className="bg-slate-200 text-black font-bold border-0">
                  <TableCell className="font-bold text-black">TOTAL AP PAYABLES</TableCell>

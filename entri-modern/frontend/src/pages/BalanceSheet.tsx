          ...
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              <Table className="w-full">
                ...
                <TableBody>
                  {/* ASSETS SECTION */}
                  <TableRow className="font-bold text-slate-900 border-b border-slate-200 bg-white">
                  ...
                  {data.assets?.accounts?.map((a: any) => (
                    <TableRow key={a.name} className="hover:bg-slate-50 border-b border-slate-100 bg-white">
                  ...
                  {(!data.assets?.accounts || data.assets.accounts.length === 0) && (
                    <TableRow>
                      <TableCell colSpan={2} className="pl-10 text-slate-500 py-3 italic border-b border-slate-100 bg-white">
                        No asset accounts recorded
                      </TableCell>
                    </TableRow>
                  )}
                  <TableRow className="bg-slate-200 font-bold border-t-2 border-b border-slate-300">
                  ...
                  {/* GRAND TOTAL SECTION */}
                  <TableRow className="bg-slate-200 font-bold border-t-2 border-slate-300 text-base">

...
export default function ARAging() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const data = await api.getReport('ar-aging')
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 no-print">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={() => exportToPDF('Accounts Receivable Aging')} className="bg-blue-600 hover:bg-blue-700 text-white">
            ...
            <Table className="w-full">
              ...
              <TableBody>
                ...
                <TableRow className="bg-slate-200 text-slate-900 font-bold border-t-2 border-slate-300">
                  <TableCell className="font-bold text-slate-900">TOTAL AR RECEIVABLES</TableCell>
